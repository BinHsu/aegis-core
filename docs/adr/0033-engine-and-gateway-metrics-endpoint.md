...
Landing-zone reversed the observability backend from self-hosted kube-prometheus-stack to Grafana Cloud free tier via [ldz ADR-022](https://github.com/BinHsu/aegis-landing-zone-aws/blob/main/docs/decisions/022-observability-backend-grafana-cloud.md) + [ldz ADR-023](https://github.com/BinHsu/aegis-landing-zone-aws/blob/main/docs/decisions/023-observability-responsibility-model.md) (ldz PR #123 merged 2026-04-21 06:59 UTC). ACK'd by aegis-core on [#46](https://github.com/BinHsu/aegis-core/issues/46).
